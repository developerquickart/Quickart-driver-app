class DriverStatus {
  ...
  DriverStatus(
      {this.status,
        ...
        this.pendingOrders,
        this.completedOrders, this.insight_total_orders});
  ...
  DriverStatus.fromJson(Map<String, dynamic> json) {
    ...
    insight_total_orders = json['insight_total_orders'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['completed_orders'] = this.completedOrders;
        data['insight_total_orders'] = this.insight_total_orders;
