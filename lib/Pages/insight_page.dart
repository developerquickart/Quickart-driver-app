...
class InsightState extends State<Insight> {
  ...
  void getOrderHistory() async {
    ...
    print(completedOrdersUrl);
    http.post(completedOrdersUrl,
    ...
    http.post(driverStatusUri,
      ...
      if (value.statusCode == 200) {
        ...
        if ('${dstatus.status}' == '1') {
          ...
          totalOrder = int.parse('${dstatus.insight_total_orders}');
            ...
            children: <Widget>[
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    buildRowChild(
                        theme, '$totalOrder', 'Total ${locale!.orders} : '),
                  ],
                ),
              ),
              Divider(thickness: 6),
          ...
          Row(
            children: [
              ...
              RichText(
                ...
                TextSpan(
                    text:
                        locale!.deliveryDate! + ': ${newOrder.deliveryDate}\n',
                    style: TextStyle(
                        fontSize: 14,
                        color: kBorderColor,
                        fontFamily: 'Poppins')),
                TextSpan(
                    ...
                    style: TextStyle(
                        ...
                        color: kBorderColor)),
                TextSpan(
                    text: '#${newOrder.delivery_unique_code}',
                    style: TextStyle(
