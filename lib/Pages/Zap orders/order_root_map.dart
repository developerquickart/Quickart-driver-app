...
Future<void> loadCustomMarkers() async {
  storeIcon = await getMarkerIcon('assets/store.png');
  customerIcon = await getMarkerIcon('assets/customer.png');
  driverIcon = await getMarkerIcon('assets/driver.png');
  setState(() {});
}
