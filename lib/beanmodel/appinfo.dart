class AppInfoModel {
  ...
  AppInfoModel.fromJson(Map<String, dynamic> json) {
    ...
    forcefully_update = json['forcefully_update'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['forcefully_update'] = this.forcefully_update;
    return data;
  }

  @override
  String toString() {
    return 'AppInfoModel{status: $status, message: $message, lastLoc: $lastLoc, phoneNumberLength: $phoneNumberLength, appName: $appName, appLogo: $appLogo, firebase: $firebase, countryCode: $countryCode, firebaseIso: $firebaseIso, sms: $sms, currencySign: $currencySign, refertext: $refertext, totalItems: $totalItems, androidAppLink: $androidAppLink, iosAppLink: $iosAppLink, paymentCurrency: $paymentCurrency, imageUrl: $imageUrl, wishlistCount: $wishlistCount, userWallet: $userWallet, country_code: $country_code, prefix_code: $prefix_code app_link: $app_link, version:$version, forcefully_update:$forcefully_update}';
  }
}
